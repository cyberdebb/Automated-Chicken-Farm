...
# 3 "newmain.c" 2
# 18 "newmain.c"
# 1 "C:/Program Files (x86)/Microchip/MPLABX/v5.35/packs/Microchip/PIC16Fxxx_DFP/1.2.33/xc8\\pic\\include\\lcd.h" 1 3
...
void __attribute__((picinterrupt(("")))) ReposicaoDeSuprimentos(void) {
    if (TMR1IF) {
        PIR1bits.TMR1IF = 0;
        TMR1L = 0xDC;
        TMR1H = 0x0B;
