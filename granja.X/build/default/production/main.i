...
void __attribute__((picinterrupt(("")))) interrupcao() {
    if (PIR1bits.TMR1IF) {
        PIR1bits.TMR1IF = 0;
        TMR1L = 0xDC;
        TMR1H = 0x0B;
...
void main() {
    ...
    while(1) {
        ...
        if (PORTBbits.RB7==1 && (int)temp<45 && (int)temp>5) PORTBbits.RB7=0;
        ...
        if (lux == 0 && noite == 0) PORTCbits.RC6=1;
